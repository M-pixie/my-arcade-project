    ...
    <div className="min-h-screen bg-white text-[#202124] font-sans">
      ...
      <main className="pt-20">
        ...
        <section className="relative border-b border-[#dadce0] bg-[#f8f9fa] overflow-hidden">
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-24 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="flex-1 text-center lg:text-left z-10 w-full lg:max-w-2xl">
              ...
              <p className="text-[#5f6368] text-lg md:text-xl max-w-xl mx-auto lg:mx-0 leading-relaxed mb-8">
            ...
            {/* ================= PREMIUM HERO GRAPHIC (BOX HATA DIYA, SIRF CIRCLE) ================= */}
            <div className="w-full max-w-[340px] relative z-10 hidden md:block group cursor-default mx-auto lg:ml-auto lg:mr-0 mt-12 lg:mt-0">
              ...
              <div className="relative w-full aspect-square">
                ...
                {/* NO BACKDROP BOX HERE - Removed background/border/shadow */}

                {/* ROTATING RINGS & GLOW (Freely floating now) */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="absolute w-40 h-40 bg-[#1a73e8]/20 rounded-full blur-[35px] animate-pulse"></div>
                  <div className="absolute w-56 h-56 border-[1.5px] border-t-[#1a73e8]/60 border-r-transparent border-b-[#34a853]/60 border-l-transparent rounded-full animate-[spin_12s_linear_infinite]"></div>
                  <div className="absolute w-44 h-44 border border-dashed border-[#ea4335]/40 rounded-full animate-[spin_20s_linear_infinite_reverse]"></div>
                </div>

                {/* CENTRAL CORE LOGO (Freely floating) */}
                ...
                {/* --- FLOATING CARDS (Freely floating around circles) --- */}
                {/* 1. Cloud Skill Boost (Top Left) */}
                <div className="absolute -top-2 -left-2 bg-white/95 backdrop-blur-md p-2 pr-3 border border-white/80 rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] z-30 float-premium flex items-center gap-2">
                  <div className="bg-gradient-to-br from-[#e6f4ea] to-[#ceead6] p-1.5 rounded-lg shadow-inner">
                    <svg className="w-4 h-4 text-[#137333]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                    </svg>
                  </div>
                  <div>
                    <div className="text-[11px] font-bold text-[#202124]">Cloud Labs</div>
                    <div className="text-[9px] text-[#137333] font-bold flex items-center gap-1 mt-0.5">
                ...
                <div className="absolute top-8 -right-4 bg-white/95 backdrop-blur-md p-2 pr-3 border border-white/80 rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] z-30 float-premium-delay flex items-center gap-2">
                  <div className="bg-gradient-to-br from-[#fce8e6] to-[#fad2cf] p-1.5 rounded-lg shadow-inner">
                    <svg className="w-4 h-4 text-[#c5221f]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="text-[11px] font-bold text-[#202124]">Swags</div>
                    <div className="text-[9px] text-[#5f6368] font-semibold mt-0.5">Unlocked 🎉</div>
                  </div>
                </div>

                {/* 3. Arcade Points (Bottom Right) */}
                <div className="absolute bottom-12 -right-2 bg-white/95 backdrop-blur-md p-2 pr-3 border border-white/80 rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] z-30 float-premium flex items-center gap-2">
                  <div className="bg-gradient-to-br from-[#fef7e0] to-[#fde293] p-1.5 rounded-lg shadow-inner">
                    <svg className="w-4 h-4 text-[#b06000]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="text-[11px] font-bold text-[#202124]">Arcade Points</div>
                    <div className="text-[10px] text-[#b06000] font-extrabold mt-0.5">+100 PTS</div>
                  </div>
                </div>

                {/* 4. Skill Badge (Bottom Left) */}
                <div className="absolute -bottom-2 left-2 bg-white/95 backdrop-blur-md p-2 pr-3 border border-white/80 rounded-xl shadow-[0_4px_20px_rgb(0,0,0,0.06)] z-30 float-premium-delay flex items-center gap-2">
                  <div className="bg-gradient-to-br from-[#e8f0fe] to-[#d2e3fc] p-1.5 rounded-lg shadow-inner">
                    <svg className="w-4 h-4 text-[#1a73e8]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                    </svg>
                  </div>
                  <div>
                    <div className="text-[11px] font-bold text-[#202124]">Skill Badge</div>
                    <div className="text-[9px] text-[#1a73e8] font-bold mt-0.5">Verified ✓</div>
                  </div>
                </div>

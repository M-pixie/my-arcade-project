            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-16">
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white font-bold shadow-lg shadow-blue-200">
                    A
                  </div>
                ...
                <p className="text-slate-500 text-sm leading-7 mb-6 max-w-sm">
                  ...
                  <br /><strong>“Disclaimer: This website is an independent, community-built tool and is not 
                  an official website of Google Cloud Arcade or Google. All trademarks and brand names belong to their respective owners.”
                  </strong>
                </p>
              </div>
              ...
              <div className="lg:col-span-1">
                <h4 className="text-slate-900 font-semibold mb-6">Platform</h4>
        ...
        <strong>Syllabus</strong>
              ...
              <div className="lg:col-span-2">
                ...
                <p className="text-sm text-slate-500 mb-4">
                  ...
                  <strong>for the latest Arcade updates.</strong>
                </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-5">
                ...
                {/* GitHub */}
                <a href="https://github.com/M-pixie" target="_blank" className="group">
                  <svg className="w-6 h-6 fill-slate-400 transition-all duration-300 group-hover:fill-slate-900 group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* LinkedIn */}
                <a href="https://linkedin.com/in/manish-ui" target="_blank" className="group">
                  <svg className="w-6 h-6 fill-slate-400 transition-all duration-300 group-hover:fill-[#0077b5] group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>

                {/* Instagram */}
                <a href="https://instagram.com/urpixie7" target="_blank" className="group">
                  <svg className="w-6 h-6 fill-slate-400 transition-all duration-300 group-hover:fill-[#E1306C] group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/8867400608" target="_blank" className="group">
                  <svg className="w-6 h-6 fill-slate-400 transition-all duration-300 group-hover:fill-[#25D366] group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

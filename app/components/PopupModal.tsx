      ...
      <div className="relative w-full max-w-[440px] bg-white rounded-xl shadow-2xl p-6 animate-in zoom-in-95 duration-300">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs mt-0.5">Join channels for real-time announcements.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-lg shadow-sm p-4 flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-gray-900 font-bold text-sm">Official Channel</h3>
              <p className="text-gray-500 text-[10px]">ANNOUNCEMENTS ONLY</p>
            </div>
          </div>
